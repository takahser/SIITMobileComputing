...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Obtain array of scores (convert a Set to an Array)
    NSArray *scoreArray = [self.scoreData allObjects];
    Score *score = (Score *)[scoreArray objectAtIndex:indexPath.row];
    
    // A voir
    Student *student = score.forStudent;
    
    cell.textLabel.text = [NSString stringWithFormat:@"%@ = %lf", student.name, [score.score doubleValue]];
    return cell;
}
